      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            A better way to find roommates and rentals
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            RentRoomie combines the best of roommate matching and property rentals into one seamless experience.
          </p>
        </div>
          ...
          <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            ...
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Curated Property Listings</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-gray-500">
                Browse apartments, condos, and houses that match your budget and location preferences. All listings are verified for quality.
              </dd>
            </div>
            ...
            <div className="relative">
              ...
              <dd className="mt-2 ml-16 text-base text-gray-500">
                Chat with potential roommates directly in the app. Schedule viewings and discuss housing details in a secure environment.
              </dd>
            </div>
          </dl>
        </div>
